...
import { GetTotalFoodAndDishFoodQuantityFromOneItemInput, FoodWithQuantity, GetTotalFoodAndDishFoodQuantityFromAllItemsInput } from "@/store/models/schedule/schedule.domain.types"
