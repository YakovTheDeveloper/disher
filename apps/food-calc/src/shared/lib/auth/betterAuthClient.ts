...
// answered without a round-trip — hence `disher.lastUser` in authProvider,
...
// and a 401 means "sign out" (handled by authProvider). The server sets
...
export const authClient = createAuthClient({
  ...
  // OIDC login (see shared/lib/auth/authProvider.signInWithOAuth). The
