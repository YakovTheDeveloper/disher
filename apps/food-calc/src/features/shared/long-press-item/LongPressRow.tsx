...
const LongPressRow = ({
  ...
  // не увидит id в ящике, так что появление проигрывается ровно один раз. Заморожено:
  ...
  // ЭКРАН (весь список наплывает по stagger), а одиночное добавление играет СВОЮ
  // анимацию появления (`.row_recent`: медленный наплыв снизу ~2.5s). Две `animation`
  // на одном узле конфликтовали бы — поэтому либо каскад, либо recent. Обычная const:
