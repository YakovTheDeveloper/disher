 ...
 * над remount'ом, поэтому выбор держится внутри сессии модалки, пока юзер сам не
 * снимет его крестиком. На закрытие модалки стор чистит handleClose флоу
 * (useFoodEntryFlow) — key-бамп его не сносит, поэтому сброс явный.
 *
