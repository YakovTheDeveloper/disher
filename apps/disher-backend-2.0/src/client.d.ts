export declare const prisma: import("apps/disher-backend-2.0/src/generated/prisma/runtime/library").DynamicClientExtensionThis<import("./generated/prisma").Prisma.TypeMap<import("apps/disher-backend-2.0/src/generated/prisma/runtime/library").InternalArgs & {
    result: {};
    model: {
        $allModels: {
