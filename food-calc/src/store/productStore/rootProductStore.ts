...
export class ProductStore {
    constructor({ id, name, nutrients = {}, portions = [] }: ProductInit) {
        ...
        this.portions = portions.map(portion => new ProductPortionStore(portion))
        makeObservable(this, {
            id: observable,
            name: observable,
    ...
    addPortion = () => {
        this.portions.push(new ProductPortionStore({ id: GenerateId(), name: 'Новая порция', quantity: 0 }))
    }
...
export class ProductPortionStore {
